...
interface ShiyanTaskDetailContentScreenProps {
...
export function ShiyanTaskDetailContentScreen({
  onFinalEditorStateChange,
  deliveryActions,
}: ShiyanTaskDetailContentScreenProps = {}) {
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          {recoveryNotice ? (
            <ShiyanStageRecoveryNotice
              ...
              onRetry={
                currentStage && retryActionForStage(currentStage) !== 'resume-upload'
