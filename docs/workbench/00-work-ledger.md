...
| MOB-048 | 双链路提交窄范围代码卫生收尾 | DOING | 2026-09-07 已基于最新 `dev` 开始；当前仅清理双链路 touched surface 的死 JSX、token 违例、Runtime delete 重复分支与行为测试缺口；broad architecture refactor 继续 deferred |
