...
| MOB-044 | 双入口真机验收与发布加固 | DOING | 2026-09-12 Android 真机档位 1（1-a Provider Key 本地写入/掩码/清除、3 双入口 UI、9 会话生命周期、10 安装升级覆盖、11 本地 Agent 前后台语义）已 PASS，验收基线 `dev@8c74550`；1-b/2/4/5 需真实 Provider API Key，6/7/8 需 Mira Host + Tool Gateway；iOS 全 11 条待真机；iPad AppIcon 缺口 OPEN DECISION；R2 Release Truth 待总验收后 bump version |
